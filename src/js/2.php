...
//Para la conexión deberás introducir 
//el usuario y password de tu base de datos
$con = pg_pconnect("host=localhost 
					port=5432 
					dbname=odontoiut2 
					password=1234 
					user=jesusrojas");
$insert = "UPDATE paciente SET nom_pac='$name', gram2='$gram'";
